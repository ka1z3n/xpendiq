package com.example.spendy.work
...
class BackfillWorker(
    ...
    override suspend fun doWork(): Result {
        val app = applicationContext as? SpendyApplication ?: return Result.failure()
        ...
        cursor.use {
            ...
            while (it.moveToNext()) {
                ...
                processed++
                if (result == com.example.spendy.data.repo.TransactionRepository.IngestResult.SAVED) saved++
    ...
    companion object {
        ...
        const val TAG = "spendy_backfill"
        const val UNIQUE_WORK_NAME = "spendy_backfill_once"
