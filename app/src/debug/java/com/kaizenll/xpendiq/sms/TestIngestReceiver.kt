 ...
 *   -a com.kaizenll.xpendiq.TEST_INGEST \
...
class TestIngestReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val app = context.applicationContext as? XpendiqApplication ?: return
        val pending = goAsync()
        app.appScope.launch {
            try {
    ...
    companion object {
        private const val TAG = "XpendiqTestIngest"
        const val ACTION = "com.kaizenll.xpendiq.TEST_INGEST"
    }
}
